...
A boolean data type represents one of the two values:_true_ or _false_. Any comparisons return a boolean value which is either true or false.
...
In JavaScrip we use the decrement operator to decrease a value stored in a variable.
